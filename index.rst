...
To access the cluster, enter the following URL - https://10.42.57.37:9440/console/#login in your browser.
...
- **Subnet** - 110.42.57.0/25
- **Cluster IP** - 10.42.57.39

Secondary Network

- **Secondary VLAN** - 571
- **Secondary Subnet** - 255.255.255.128
- **Secondary Gateway** - 10.42.57.129
- **Secondary IP Range** - 10.42.57.132-254
